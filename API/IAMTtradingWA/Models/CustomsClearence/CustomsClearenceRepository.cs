...
{
    public class CustomsClearenceRepository : ICustomsClearenceRepository
    {
        ...
        public CustomsClearence Add(CustomsClearence data)
        {
            SqlConnection oConn = null;
            ...
            EnumExtension.setListValues(data, "CClearenceId", ref sql);
            ...
            CustomsClearence returnData = Get(keyGenerated, oConn);
        ...
        private CustomsClearence Get(int id, SqlConnection oConn)
        {
            string sql = " SELECT * FROM vCustomsClearence WHERE (CClearenceId = @id)";
            ...
            {
                IList<CustomsClearence> data = EnumExtension.ToList<CustomsClearence>(dt);
                return data.FirstOrDefault<CustomsClearence>();
            }

            return null;
        }

        public bool Remove(CustomsClearence data)
        {
            SqlConnection oConn = null;
        ...
        private bool Remove(CustomsClearence data, SqlConnection oConn)
        {
            string sql = "DELETE FROM CustomsClearence " +
                         " WHERE (CClearenceId = @id)";

            sql = String.Format(sql, data.CClearenceId);
        ...
        public CustomsClearence GetByQuote(int quoteId, int mode = 0)
        {
            SqlConnection oConn = null;
            ...
            CustomsClearence data = GetByQuote(quoteId, mode, oConn);
        ...
        private CustomsClearence GetByQuote(int quoteId, int mode, SqlConnection oConn)
        {
            string sql = " SELECT * FROM vCustomsClearence WHERE (QHeaderId = @quoteId AND CClearenceMode = @mode)";

            SqlDataAdapter da = new SqlDataAdapter(sql, oConn);

            da.SelectCommand.Parameters.Add("@quoteId", SqlDbType.Int).Value = Convert.ToInt32(quoteId);
            da.SelectCommand.Parameters.Add("@mode", SqlDbType.Int).Value = Convert.ToInt32(mode);
