...
namespace IAMTradingWA.Controllers
{
    ...
    [TokenValidation]
    public class GeneralChargesController : ApiController
    {
        static readonly IGeneralChargesRepository repository = new GeneralChargesRepository();
        ...
        public object GetAll()
        {
            ...
            try
            {
                ...
                {
                    GeneralCharge estatus = repository.Get(id);
        ...
        public object Post(GeneralCharge added)
        {
            object json;

            try
            {
                GeneralCharge posted = repository.Add(added);
        ...
        public object Put(GeneralCharge updated)
        {
            object json;

            try
            {
                GeneralCharge putting = repository.Update(updated);
        ...
        public object Delete(GeneralCharge deleted)
        {
            object json;
