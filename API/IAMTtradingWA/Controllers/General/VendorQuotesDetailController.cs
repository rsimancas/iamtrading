...
namespace IAMTradingWA.Controllers
{
    ...
    [TokenValidation]
    public class VendorQuotesDetailController : ApiController
    {
        static readonly IVendorQuotesDetailRepository repository = new VendorQuotesDetailRepository();
        ...
        public object GetAll()
        {
            ...
            try
            {
                if (id == 0)
                {
                    object json;
                    string msgError = "";
                    var lista = repository.GetList(VendorQuoteId, query, sort, page, start, limit, ref totalRecords, ref msgError);
        ...
        public object Put(VendorQuoteDetail model)
        {
            object json;
