...
namespace IAMTradingWA.Controllers
{
    ...
    {
        static readonly IPurchaseOrderRepository repository = new PurchaseOrderRepository();
        ...
        public object Put(Models.PurchaseOrder updated)
        {
            object json;
            ...
            {
                string messageError = "";
                Models.PurchaseOrder putting = repository.Update(updated, ref messageError);
