                            ...
                            grid.tip = Ext.create('Ext.tip.ToolTip', {
                                ...
                                listeners: {
                                    beforeshow: function updateTipBody(tip) {
                                        ...
                                        myToolTipText = "<b>{0}</b>".format(record.get("QHeaderReference"));
                                                myToolTipText = myToolTipText + "<br/>Vendor: {0}".format(record.get('x_VendorName'));
                                                myToolTipText = myToolTipText + "<br/>Broker: {0}".format(record.get('x_BrokerName'));
                                                myToolTipText = myToolTipText + "<br/>Status: {0}".format(record.get('x_StatusName'));
    ...
    onClickEditHeader: function(record) {
        ...
        var storeQuoteHeader = new IAMTrading.store.QuoteHeader().load({
            ...
            callback: function() {
                ...
                var vendorId = selectedRecord.data.VendorId;
                ...
                var storeVendors = new IAMTrading.store.Vendors().load({
                    ...
                    callback: function() {
                        var formEdit = new IAMTrading.view.EditQuoteHeader({
                            currentRecord: selectedRecord,
                            title: 'Quote of {0} Reference #:{1}'.format(record.data.x_CustName, record.data.QHeaderReference)
                        });
                        formEdit.down('field[name=VendorId]').bindStore(this);
                        formEdit.down('field[name=VendorId]').setValue(vendorId);
                        formEdit.loadRecord(selectedRecord);
                        formEdit.callerForm = me;
                        //form.center();
                        //form.show();
