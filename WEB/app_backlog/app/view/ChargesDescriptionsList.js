Ext.define('IAMTrading.view.ChargesDescriptionsList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.ChargesDescriptionsList',
    title: 'Charges Descriptions',

    initComponent: function() {
        var me = this;

        var storeCategories = new IAMTrading.store.ChargesCategories({
            pageSize: 0
        }).load();
        ...
        Ext.applyIf(me, {
            items:[
            {
                ...
                columns: [
                {
                    ...
                    sortable: true,
                    width: 80,
                    dataIndex: 'ChargeDescId',
                    text: 'ID',
                    format: '000'
                }, {
                    xtype: 'gridcolumn',
                    dataIndex: 'CCategoryName',
                    flex: 1,
                    text: 'Category',
                    editor: {
                        xtype: 'combo',
                        displayField: 'CCategoryName',
                        valueField: 'CCategoryId',
                        name: 'CCategoryId',
                        queryMode: 'local',
                        typeAhead: true,
                        minChars: 2,
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        var r = Ext.create('IAMTrading.model.ChargesDescriptions');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(r, 1);
                        rowEditing.editor.down('field[name=CCategoryName]').focus(true, 200);
                    }
                }, 
                {
                    itemId: 'deleteline',
