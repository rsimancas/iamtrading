Ext.define('IAMTrading.view.ChargesCategoriesList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.ChargesCategoriesList',
    title: 'Charges Categories',

    initComponent: function() {
        var me = this;

        var storeChargesCategories = new IAMTrading.store.ChargesCategories().load();
        ...
        Ext.applyIf(me, {
            items:[
            {
                ...
                minHeight: 450,
                forceFit: true,
                store: storeChargesCategories,
                columns: [
                {
                    xtype: 'numbercolumn',
                    sortable: true,
                    width: 80,
                    dataIndex: 'CCategoryId',
                    text: 'ID',
                    format: '000'
                },
                {
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        var r = Ext.create('IAMTrading.model.ChargesCategories');
