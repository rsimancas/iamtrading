Ext.define('IAMTrading.view.SequencesList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.sequenceslist',
    title: 'Sequences',

    initComponent: function() {
        var me = this;

        var storeSequences = new IAMTrading.store.Sequences().load();
            ...
            items: [{
                ...
                tbar: [{
                    ...
                    handler: function() {
                        ...
                        var r = Ext.create('IAMTrading.model.Sequences');
