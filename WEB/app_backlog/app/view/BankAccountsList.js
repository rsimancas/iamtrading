Ext.define('IAMTrading.view.BankAccountsList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.bankaccountslist',
    title: 'BankAccounts',

    initComponent: function() {
        var me = this;

        var storeBankAccounts = new IAMTrading.store.BankAccounts().load();

        var storeBanks = new IAMTrading.store.Banks({
            pageSize: 0
        }).load();
            ...
            items: [{
                ...
                tbar: [{
                    ...
                    handler: function() {
                        ...
                        var r = Ext.create('IAMTrading.model.BankAccounts');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(r, 1);
                        rowEditing.editor.down('field[name=BankID]').focus(true, 200);
                    }
                }, {
                    itemId: 'deleteline',
                    text: 'Delete',
    ...
    onClickActionColumn: function(view, rowIndex, colIndex, item, e, record) {
        ...
        this.up('panel').editingPlugin.editor.down('field[name=BankID]').focus(true, 200);
    }
