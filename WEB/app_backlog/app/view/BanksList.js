Ext.define('IAMTrading.view.BanksList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.bankslist',
    title: 'Banks',

    initComponent: function() {
        var me = this;

        var storeBanks = new IAMTrading.store.Banks().load();
            ...
            items: [{
                ...
                tbar: [{
                    ...
                    handler: function() {
                        ...
                        var r = Ext.create('IAMTrading.model.Banks');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(r, 1);
                        rowEditing.editor.down('field[name=BankName]').focus(true, 200);
                    }
                }, {
                    itemId: 'deleteline',
                    text: 'Delete',
    ...
    onClickActionColumn: function(view, rowIndex, colIndex, item, e, record) {
        ...
        this.up('panel').editingPlugin.editor.down('field[name=BankName]').focus(true, 200);
    }
