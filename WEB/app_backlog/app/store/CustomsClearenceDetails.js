Ext.define('IAMTrading.store.CustomsClearenceDetails', {
    extend: 'Ext.data.Store',
    alias: 'store.CustomsClearenceDetails',
    autoLoad: false,
    pageSize: 16,

    requires: [
        'IAMTrading.model.CustomsClearenceDetails'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            model: 'IAMTrading.model.CustomsClearenceDetails',
