Ext.define('IAMTrading.store.PaymentVendorDetails', {
    extend: 'Ext.data.Store',
    alias: 'store.PaymentVendorDetails',
    autoLoad: false,
    pageSize: 16,

    requires: [
        'IAMTrading.model.PaymentVendorDetails'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            model: 'IAMTrading.model.PaymentVendorDetails',
            remoteSort: true,
            proxy: {
                type: 'rest',
