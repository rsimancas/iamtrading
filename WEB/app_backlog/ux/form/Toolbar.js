Ext.define('Ext.ux.form.Toolbar', {
     ...
     */
    emptyMsg : 'No hay información para mostrar',
    //</locale>
    ...
    */
    ...
    setReadOnlyFormFields: function (bReadOnly) {
        ...
        formpanel.getForm().getFields().each (function (field) {
            if(field.editable && field.xtype != "searchfield")
