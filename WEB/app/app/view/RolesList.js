Ext.define('IAMTrading.view.RolesList', {
    ...
    initComponent: function() {
        ...
        var storeRoles = new IAMTrading.store.Roles().load();
            ...
            items: [{
                ...
                tbar: [{
                    ...
                    handler: function() {
                        ...
                        var r = Ext.create('IAMTrading.model.Roles');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(r, 1);
                        rowEditing.editor.down('field[name=RoleName]').focus(true, 200);
                    }
                }, {
                    itemId: 'deleteline',
                    text: 'Delete',
    ...
    onClickActionColumn: function(view, rowIndex, colIndex, item, e, record) {
        ...
        this.up('panel').editingPlugin.editor.down('field[name=RoleName]').focus(true, 200);
    }
});