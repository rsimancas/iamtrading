Ext.define('IAMTrading.view.PaymentModesList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.paymentmodeslist',
    title: 'Payment Modes',

    initComponent: function() {
        var me = this;

        var storePaymentModes = new IAMTrading.store.PaymentModes().load();
        ...
        Ext.applyIf(me, {
            items: [{
                ...
                columns: [{
                    ...
                    xtype: 'gridcolumn',
                    flex: 1,
                    dataIndex: 'PayModeDescription',
                    text: 'Name',
                    editor: {
                        xtype: 'textfield',
                        name: 'PayModeDescription',
                ...
                tbar: [{
                    ...
                    handler: function() {
                        ...
                        var r = Ext.create('IAMTrading.model.PaymentModes');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(r, 1);
                        rowEditing.editor.down('field[name=PayModeDescription]').focus(true, 200);
                    }
                }, {
                    itemId: 'deleteline',
                    text: 'Delete',
    ...
    onClickActionColumn: function(view, rowIndex, colIndex, item, e, record) {
        ...
        this.up('panel').editingPlugin.editor.down('field[name=PayModeDescription]').focus(true, 200);
    }
