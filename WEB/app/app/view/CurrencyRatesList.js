Ext.define('IAMTrading.view.CurrencyRatesList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.currencyrateslist',
    title: 'Currency Rates',

    initComponent: function() {
        var me = this;

        var storeCurrencyRates = new IAMTrading.store.CurrencyRates().load();
            ...
            items:[
            {
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        var r = Ext.create('IAMTrading.model.CurrencyRates');
