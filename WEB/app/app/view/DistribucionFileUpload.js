Ext.define('IAMTrading.view.DistribucionFileUpload', {
    extend: 'Ext.form.Panel',
    alias: 'widget.distribucionfileupload',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            },
            {
                ...
                src:'../wa/api/attachment/' + me.MovId + '?_'+ new Date().getTime()
            },
            {
                xtype: 'component',
                columnWidth: 0.4
            ...
            buttons: [
            {
                ...
                listeners:{
                    ...
                    change: function() {
                        var imgShow = this.up('form').down('image').getEl();
