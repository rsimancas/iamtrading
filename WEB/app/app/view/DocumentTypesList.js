Ext.define('IAMTrading.view.DocumentTypesList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.documenttypeslist',
    title: 'DocumentTypes',

    initComponent: function() {
        var me = this;

        var storeDocumentTypes = new IAMTrading.store.DocumentTypes().load();
            ...
            items:[
            {
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        var r = Ext.create('IAMTrading.model.DocumentTypes');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(r, 1);
                        rowEditing.editor.down('field[name=DocTypeName]').focus(true, 200);
                    }
                }, 
                {
                    itemId: 'deleteline',
